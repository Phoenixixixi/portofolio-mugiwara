...
import Animation from '@/components/ui/home/text'
    ...
    <div className="w-full min-h-screen flex flex-col md:items-center md:pt-24 pt-12 ">
      <SparklesBackground>
        ...
        <div className="flex gap-x-4 md:pt-4 pt-8">
          <Link
            className="flex items-center justify-center min-w-32 rounded-full cursor-pointer bg-black dark:bg-white text-white dark:text-black py-2 font-semibold"
            href={'/about'}
          >
            About Me
          </Link>
